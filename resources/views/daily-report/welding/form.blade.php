            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        @endif
                        <form action="{{ url('/daily-report/welding/detail/store') }}" method="POST"
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h3 class="card-title">Daily Report Form Welding: {{ $item->document_no }}
                                                ({{ $item->shift }} Shift {{ $item->date }})</h3>
                                                            ...
                                                            <div class="form-group mt-4">
                                                                <div class="row">
                                                                    <div class="col-md-3 mb-3">
                                                                        <label for="manpower_plan">Man Power Total
                                                                            Plan</label>
                                                                    ...
                                                                    <div class="col-md-3 mb-3">
                                                                        ...
                                                                        <input type="text" inputmode="numeric"
                                                                            ...
                                                                            class="form-control form-control-sm"
                                                                            style="width: 100px;" value={{ $working_hour }}
                                                                            min="0">
                                                                    </div>
