            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <form action="{{ url('/daily-report/welding/detail/update') }}" method="POST"
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h3 class="card-title">Daily Report Form Welding: {{ $header->document_no }}
                                                ({{ $header->shift }} Shift {{ $header->date }})</h3>
                                                                        ...
                                                                        <table class="table table-bordered">
                                                                            ...
                                                                            <tbody>
                                                                                @foreach ($data['stations'] as $station)
                                                                                    <tr>
                                                                                        <td style="width: 50px;"
                                                                                            rowspan="{{ count($station['models']) + 1 }}">
                                                                                        ...
                                                                                        <td style="width: 75px;"
                                                                                            ...
                                                                                            <input type="text"
                                                                                                inputmode="numeric"
                                                                                                name="manpower_station[{{ $station['station_name'] }}]"
                                                                                                class="form-control form-control-sm"
                                                                                                value="{{ $station['manpower_station'] }}"
                                                                                                min="0">
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <div style="width: 400px;"
                                                                                                    ...
                                                                                                    <div class="col-md-4">
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            class="form-control form-control-sm"
                                                                                                            style="width: 80px;"
                                                                                                            value="{{ number_format($model['hour'], 2) }}"
                                                                                                            min="0">
                                                                                                    </div>
                                                                                                    <div class="col-md-8">
                                                                                                        <label>Plan
                                                                                            ...
                                                                                            <td>
                                                                                                <div style="width: 400px;"
                                                                                                    ...
                                                                                                    <div class="col-md-4">
                                                                                                        <label>Remarks</label>
                                                                                                        <textarea name="production[{{ $model['model_name'] }}][remarks][]" class="form-control form-control-sm"
