            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <form action="{{ url('/daily-report/press/detail/update') }}" method="POST"
                                                                                ...
                                                                                @foreach ($data['models'] as $model)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-center">
                                                                                            <label
                                                                                                style="font-weight: bold;">{{ $model['model_name'] }}</label>
                                                                                            <label>Status</label>
                                                                                            <select
                                                                                                name="production[{{ $model['production_id'] }}][status][]"
                                                                                            ...
                                                                                            <input type="text"
                                                                                                name="production[{{ $model['production_id'] }}][inc_material][]"
                                                                                                class="form-control form-control-sm"
                                                                                                placeholder="Incoming Material"
                                                                                                value="{{ $model['inc_material'] }}">
                                                                                        </td>
                                                                                        <td>
                                                                                            <div class="row">
                                                                                                <div class="col-md-4">
                                                                                                    <label>Production
                                                                                                        Process</label>
                                                                                                    <input type="text"
                                                                                                        name="production[{{ $model['production_id'] }}][production_process][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                ...
                                                                                                <div class="col-md-4">
                                                                                                    <label>Type</label>
                                                                                                    <input type="text"
                                                                                                        name="production[{{ $model['production_id'] }}][type][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                        value="{{ $model['type'] }}"
                                                                                                        min="0">
                                                                                                </div>
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        inputmode="numeric"
                                                                                                        name="production[{{ $model['production_id'] }}][machine][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                        value="{{ $model['machine'] }}"
                                                                                                        min="0">
                                                                                                </div>
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        inputmode="numeric"
                                                                                                        name="production[{{ $model['production_id'] }}][setting][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                        value="{{ $model['setting'] }}"
                                                                                                        min="0">
                                                                                                </div>
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="time"
                                                                                                        name="production[{{ $model['production_id'] }}][hour_from][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                ...
                                                                                                <div class="col-md-4">
                                                                                                    <label>Hour To</label>
                                                                                                    <input type="time"
                                                                                                        name="production[{{ $model['production_id'] }}][hour_to][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                        value="{{ $model['hour_to'] }}">
                                                                                                </div>
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        inputmode="numeric"
                                                                                                        name="production[{{ $model['production_id'] }}][plan_prod][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                ...
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        inputmode="numeric"
                                                                                                        name="production[{{ $model['production_id'] }}][OK][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                        value="{{ $model['OK'] }}"
                                                                                                        min="0">
                                                                                                </div>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="row">
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        inputmode="numeric"
                                                                                                        name="ng[{{ $model['production_id'] }}][rework][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                        value="{{ $model['rework'] }}"
                                                                                                        min="0">
                                                                                                </div>
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        inputmode="numeric"
                                                                                                        name="ng[{{ $model['production_id'] }}][dmg_part][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                ...
                                                                                                <div class="col-md-4">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        inputmode="numeric"
                                                                                                        name="ng[{{ $model['production_id'] }}][dmg_rm][]"
                                                                                                        class="form-control form-control-sm"
                                                                                                        value="{{ $model['dmg_rm'] }}"
                                                                                                        min="0">
                                                                                                </div>
                                                                                                <div class="col-md-4">
                                                                                                    <label>Remarks</label>
                                                                                                    <textarea name="ng[{{ $model['production_id'] }}][remarks][]" class="form-control form-control-sm" rows="2">{{ $model['remarks'] }}</textarea>
                                                                                                </div>
                                                                                                <div class="col-md-8">
                                                                                                    <label>Photo NG</label>
                                                                                                    <input type="file"
                                                                                                        name="ng[{{ $model['production_id'] }}][photo_ng][]"
                                                                                                        class="form-control form-control-sm">
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
