                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Press Daily Reports</h3>
                                    </div>
                                    <!-- Export Modal -->
                                    <div class="modal fade" id="modal-export" tabindex="-1"
                                        aria-labelledby="modal-export-label" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ url('/daily-report/press/export') }}" method="POST">
                                                    @csrf
                                            ...
                                            <div class="mb-3 col-sm-12">
                                                ...
                                                <div class="modal fade" id="modal-add" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modal-add-label">Add Daily
                                                                    Report</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <form action="{{ url('/daily-report/press/store/main') }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="modal-body">
                                                                    <div class="form-group mb-3">
                                                                        <select name="shift" id="shift"
                                                                            ...
                                                                            @foreach ($categories as $shift)
                                                                                <option value="{{ $shift->name_value }}">
                                                                                    {{ $shift->name_value }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group mb-3">
                                                                    ...
                                                                    <div class="form-group mb-3">
                                                                        <input type="text" class="form-control"
                                                                            id="pic" name="pic" placeholder="PIC"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a title="Detail Report"
                                                                    href="{{ url('/daily-report/press/detail/' . encrypt($data->id)) }}"
